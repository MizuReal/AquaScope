...
function ParallaxBackground({ speed = -0.3 }) {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "linear-gradient(rgba(255, 255, 255, 0.15), rgba(255, 255, 255, 0.25)), url('https://images.pexels.com/photos/918642/pexels-photo-918642.jpeg')",
...
const developers = [
  { name: "Kim Jensen Yebes", photo: "/dev1.png", github: "#" },
  { name: "Jay Tabigue",       photo: "/dev2.png", github: "#" },
  { name: "Ryan Russel Antoniano", photo: "/dev3.png", github: "#" },
  { name: "Al Samuel Crueta", photo: "/dev4.png", github: "#" },
];
    ...
    <div className="carousel-root relative overflow-hidden bg-white">
      <div className="relative h-[400px] w-full sm:h-[500px] lg:h-[600px]">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 sm:p-12">
          <h3 className="text-4xl font-extrabold tracking-tight text-white drop-shadow-lg sm:text-5xl lg:text-6xl">
            {slide.title}
          </h3>
          ...
          {carouselSlides.map((_, i) => (
            <button
              ...
              className={`h-2.5 rounded-full transition-all duration-300 ${
                i === current
                  ? "w-10 bg-gradient-to-r from-sky-600 to-sky-500 shadow-md shadow-sky-600/30"
  ...
  return (
    <>
      ...
      <main className="space-y-0">
                ...
                <div className="grid grid-cols-2 gap-5">
                  {stats.map((stat, idx) => (
                    ...
                    >
                      ...
                      <p className="relative bg-gradient-to-br from-sky-600 to-cyan-600 bg-clip-text text-4xl font-extrabold text-transparent">
                        {stat.value}
                      </p>
          ...
          <div className="overflow-hidden">
            <div className="ticker-track whitespace-nowrap text-sm font-bold uppercase tracking-[0.3em] text-slate-400">
              {[...tickerLabels, ...tickerLabels].map((item, i) => (
                <span
                  key={`${item.label}-${i}`}
                  className={`inline-flex items-center gap-4 pr-8 ${item.color} transition-colors hover:text-sky-600`}
                >
                  {item.label}
          ...
          <div className="relative z-10 mx-auto max-w-6xl">
            <Reveal>
              <div className="mx-auto max-w-3xl text-center">
                ...
                <h2 className="mt-8 text-4xl font-bold tracking-tight text-slate-900 drop-shadow-[0_2px_10px_rgba(255,255,255,0.8)] md:text-5xl">
                  What does this system do?
                </h2>
                <p className="mt-6 text-lg font-semibold leading-relaxed text-slate-900 drop-shadow-[0_2px_8px_rgba(255,255,255,0.8)]">
                ...
                <div className="mt-10 flex flex-col items-center gap-5 sm:flex-row sm:justify-center">
                  <div className="group rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-lg backdrop-blur-md transition-all hover:-translate-y-1 hover:bg-white/90 hover:shadow-xl">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-sm text-slate-500">App Store &amp; Play Store</p>
                      </div>
                    </div>
                  </div>
                  <div className="group rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-lg backdrop-blur-md transition-all hover:-translate-y-1 hover:bg-white/90 hover:shadow-xl">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-sm text-slate-500">Any browser, no install</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-20 space-y-4">
              <Reveal>
                <p className="text-center text-sm font-bold uppercase tracking-[0.25em] text-slate-900 drop-shadow-[0_2px_10px_rgba(255,255,255,0.8)]">
              ...
              <div className="mt-10 grid items-stretch gap-6 md:grid-cols-2 xl:grid-cols-4">
                {steps.map((step, i) => (
                  <Reveal key={step.number} delay={i * 120} className="h-full">
                    <article className="step-card flex h-full flex-col bg-white/85 p-8 shadow-xl backdrop-blur-md">
        ...
        <section id="team" className="relative overflow-hidden bg-gradient-to-b from-cyan-50/60 via-sky-50/30 to-white px-6 py-24 lg:py-32">
          <div className="pointer-events-none absolute inset-0 overflow-hidden">
            <div className="absolute -left-32 -top-32 h-96 w-96 rounded-full bg-cyan-200/20 blur-3xl" />
            <div className="absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-sky-200/15 blur-3xl" />
          </div>

          <div className="relative z-10 mx-auto max-w-6xl">
            <Reveal>
              <div className="mx-auto max-w-2xl text-center">
                <span className="inline-flex items-center gap-2 rounded-full border-2 border-sky-500 bg-gradient-to-r from-sky-600 to-sky-500 px-4 py-2 text-xs font-semibold uppercase tracking-[0.1em] text-white shadow-lg shadow-sky-600/30">
                ...
                <p className="mt-5 text-lg leading-relaxed text-slate-600">
                  AquaScope was crafted by a dedicated team of developers committed to making water
                  safety analysis smarter, faster, and accessible to everyone.
                </p>
              </div>
            </Reveal>

            <div className="mt-20 grid grid-cols-2 gap-8 xl:grid-cols-4">
              {developers.map((dev, i) => (
                <Reveal key={dev.name} delay={i * 120} className="h-full">
                  <article className="group flex h-full flex-col items-center rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-lg transition-all duration-500 hover:-translate-y-2 hover:border-sky-200 hover:shadow-xl hover:shadow-sky-100/60">
                    <div className="mb-6 h-32 w-32 flex-shrink-0">
                      <img
                        src={dev.photo}
                        alt={dev.name}
                        className="h-32 w-32 rounded-full object-cover ring-4 ring-slate-100 shadow-lg transition-all duration-500 group-hover:scale-105 group-hover:ring-sky-300"
                      />
                    </div>
                    <h3 className="mt-auto text-base font-bold leading-snug text-slate-900">{dev.name}</h3>
                    <div className="mt-5 flex gap-3">
                      <a
                        href={dev.github}
                        className="flex h-9 w-9 items-center justify-center rounded-full border border-slate-200 bg-slate-50 text-slate-500 transition-all hover:border-sky-300 hover:bg-sky-50 hover:text-sky-600"
            ...
            <Reveal delay={400}>
              <p className="mt-16 text-center text-sm text-slate-500">
                Developed as a project for System Integration 2 &mdash; combining AI, water safety research, and modern software development.
              </p>
            </Reveal>
          </div>
        </section>
            ...
            <div className="mt-16 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
              {features.map((card, i) => (
                <Reveal key={card.title} delay={i * 100}>
                  <article className="feature-card group relative p-8">
                    <span
                      className={`inline-flex h-14 w-14 items-center justify-center rounded-2xl border-2 ${card.iconColor} shadow-md transition-all group-hover:scale-110 group-hover:shadow-lg`}
                    >
                      {card.icon}
                    </span>
